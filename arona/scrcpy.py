...
class MNT:
    ...
    def init_device(cls, port=16380):
        ...
        if Scrcpy.get_adb_device_object().shell("pgrep minitouch") == "":
            cls._port = port
            ...
            Scrcpy.get_adb_device_object().shell(f'chmod 777 {dir}/{bin}')
